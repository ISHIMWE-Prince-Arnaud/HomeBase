...
async function main() {
  ...
  const h1Chores = await prisma.chore.createMany({
    data: [
      ...
      // No due date, assigned
      {
        ...
        description: 'Sort and organize tools',
        dueDate: null,
        isComplete: false,
        householdId: household1.id,
        assignedToId: alice.id,
      ...
      // Recently completed
      {
        ...
        description: 'Scrub toilet, sink, shower',
        dueDate: daysAgo(1),
        isComplete: true,
        householdId: household1.id,
        assignedToId: bob.id,
  ...
  const h2Chores = await prisma.chore.createMany({
    data: [
      ...
      {
        title: 'Walk the dog',
        description: 'Morning and evening walks',
        dueDate: daysFromNow(1),
        isComplete: false,
        householdId: household2.id,
        assignedToId: eve.id,
      ...
      {
        title: 'Cook dinner',
        description: 'Prepare family dinner',
        dueDate: daysFromNow(1),
        isComplete: false,
        householdId: household2.id,
        assignedToId: dave.id,
  ...
  await prisma.expense.create({
    data: {
      ...
      participants: {
        create: [
          { userId: alice.id, shareAmount: 22.5 },
          { userId: bob.id, shareAmount: 22.5 },
        ],
      },
    },
  });
  ...
  await prisma.notification.createMany({
    data: [
      // === CHORE ASSIGNMENTS ===
      {
        message: 'Alice assigned you: Clean the kitchen',
        type: 'chore_assigned',
        isRead: false,
        householdId: household1.id,
        userId: alice.id,
      ...
      {
        message: 'Bob assigned you: Take out trash',
        type: 'chore_assigned',
        isRead: true,
        householdId: household1.id,
        userId: bob.id,
      ...
      {
        message: 'Charlie assigned you: Vacuum living room',
        type: 'chore_assigned',
        isRead: false,
        householdId: household1.id,
        userId: charlie.id,
      ...
      {
        message: 'You have a new chore: Water plants',
        type: 'chore_assigned',
        isRead: true,
        householdId: household1.id,
        userId: alice.id,
      ...
      // === EXPENSES ===
      {
        message: 'Alice added expense: Weekly groceries ($150)',
        type: 'expense_added',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Bob added expense: Electric bill - March ($180)',
        type: 'expense_added',
        isRead: true,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Charlie added expense: Friday pizza night ($42)',
        type: 'expense_added',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'You were added to expense: Movie night',
        type: 'expense_added',
        isRead: false,
        householdId: household1.id,
        userId: bob.id,
      ...
      {
        message: 'You received $25 from Charlie',
        type: 'payment_received',
        isRead: false,
        householdId: household1.id,
        userId: bob.id,
      ...
      // === HOUSEHOLD NEEDS ===
      {
        message: 'Alice added to shopping list: Milk',
        type: 'need_added',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Bob added to shopping list: Bread',
        type: 'need_added',
        isRead: true,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Charlie added to shopping list: Eggs',
        type: 'need_added',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Bob purchased: Tomato sauce',
        type: 'need_purchased',
        isRead: true,
        householdId: household1.id,
        userId: null,
      ...
      {
        message: 'Charlie purchased: Paper towels',
        type: 'need_purchased',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      // === SYSTEM ===
      {
        message: 'Welcome to Homebase! Start by exploring your dashboard.',
        type: 'system',
        isRead: true,
        householdId: household1.id,
        userId: alice.id,
      ...
      {
        message: 'Your chore "Take out trash" is overdue!',
        type: 'system',
        isRead: false,
        householdId: household1.id,
        userId: bob.id,
      ...
      {
        message: 'Monthly expense summary is ready',
        type: 'system',
        isRead: false,
        householdId: household1.id,
        userId: null,
      ...
      {
        message:
          'New features available: Check out the updated chore scheduler',
        type: 'system',
        isRead: true,
        householdId: household1.id,
        userId: null,
      ...
      // === CHORE COMPLETIONS ===
      {
        message: 'Bob completed: Clean bathroom',
      ...
      {
        message: 'Charlie completed: Mow lawn',
        type: 'chore_completed',
        isRead: true,
        householdId: household1.id,
        userId: null,
      ...
      // === EXPENSE UPDATES ===
      {
        message: 'Alice updated expense: Weekly groceries',
      ...
      {
        message: 'Bob deleted expense: Old bill',
  ...
  await prisma.notification.createMany({
    data: [
      {
        message: 'Welcome to your new household!',
        type: 'system',
        isRead: true,
        householdId: household2.id,
        userId: dave.id,
      ...
      {
        message: 'Eve joined the household',
        type: 'household_invite',
        isRead: true,
        householdId: household2.id,
        userId: null,
      ...
      {
        message: 'Dave added expense: Mortgage ($1,500)',
        type: 'expense_added',
        isRead: false,
        householdId: household2.id,
        userId: null,
      ...
      {
        message: 'Eve added to shopping list: Dog food',
        type: 'need_added',
        isRead: false,
        householdId: household2.id,
        userId: null,
      ...
      {
        message: 'You have a chore due tomorrow: Grocery shopping',
        type: 'chore_assigned',
        isRead: false,
        householdId: household2.id,
        userId: dave.id,
  ...
  console.log(
    '     Categories: Dairy, Bakery, Household, Personal Care, Beverages, Meat, Pantry',
  );
